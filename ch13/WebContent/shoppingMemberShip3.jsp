...
<body>
    <header class="manu">
        ...
        <ul id="manu_bar3">
            ...
            <li>ORDER &nbsp </li>
            <li><a href=memberForm.jsp>MY PAGE </a> </li>
        </ul>
        <div id="ment">
            <p><a >회원가입</a></p>
            <hr id="bar">
        ...
        <div class="secsion">
            <div id="login">
                ...
                <form methd="post" action="joinMembership.do" >
                <a id="texte">기본정보</a>
                <table id="tb2">
                    <tr>
                        <th class="thS">아이디</th>
                    ...
                    <tr>
                        ...
                        <th id="th1"><input type="text" name="pwdN"  maxlength="12" ></th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th class="thS">닉네임</th>
                        <th id="th1"><input type="text"name="nicname"  maxlength="15"> <input type="submit" value="닉네임 중복 검사" onclick="javascript: form.action='nicname.do';" ></th>
                    </tr>
                     <tr>
                        <th class="thS">생일</th>
                        <th id="th1">
