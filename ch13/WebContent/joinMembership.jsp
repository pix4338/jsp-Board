...
ID : <input type="text" name="idN" id="idN" maxlength="15" value=""><br>
비밀번호 : <input type="text" name="pwdN" id="pwdN" maxlength="12" value=""><br> 
비밀번호 재확인 : <input type="password" name="pwdNe" id="pwdNe"maxlength="12"><br> 
이름 : <input type="text"name="nicname" id="nicname" value=""  maxlength="15"> <input type="submit" value="닉네임 중복 검사" onclick="javascript: form.action='nicname.do';" ><br> 
생년월일 : <input type="text"name="year" id="year"value="년(4자)"onFocus="this.value='';" style=" width:70px;"maxlength="4">
...
<br>
이메일 : <input type="text" name="email1" id="email"style="width:70px;" maxlength="21">@
<select name="email2">
...
<br> 
주소 : <input type="text" name="address" id="address"maxlength="25"><br>
휴대폰 번호 : 
...
</select> -<input type="text" name="tel2" id="tel2"style=" width:50px;"maxlength="4">-
